...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='imagenet_7_12_17_22', type=str, metavar='MODEL',
    ...
    parser.add_argument('--data_path', default=r'/home/wangkai/data/imagenet', type=str,
                        help='dataset path')
